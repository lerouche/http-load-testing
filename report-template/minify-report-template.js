...
fs.writeFileSync(__dirname + '/report-template.min.html', fs.readFileSync(__dirname + '/report-template.min.html', 'utf8').replace(/<script src=node_modules\/(.*?)><\/script>/g, (_, file) => {
